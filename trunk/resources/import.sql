...
INSERT INTO Product (id, asin, urlAlias, description, name, price, urlImageSmall) VALUES (1, 'p1', 'wifishirt', 'Майка с индикатором качества Вай-Фай сигнала', 'Wi-Fi Майка', 1500, 'http://extrapost.ru/img/product1.jpg')
...
INSERT INTO Product (id, asin, urlAlias, description, name, price, urlImageSmall) VALUES (13, 'orfograf77', 'orphograph', 'Wonderful cards set, with 120 cards, that teach you the great russian language.', 'The russian language Orphograph', 370, 'http://extrapost.ru/img/orfograf.jpg')
