               ...
               Serializable
{
    ...
    // We get the product id here. And get an image from it.
    // If we pass right the byte array, it occurs hard-coded into the final HTML. Horror!
    public void paint(OutputStream stream, Object object) throws IOException {
        assert (object instanceof Long);
        Product p = this.em.find(Product.class, (Long)object);
